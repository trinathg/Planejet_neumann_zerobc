...
{ 
	...
	for(int j=1;j<ny;j++)
	{
		for(int i=1;i<nx;i++) 
		{
			...
			fvar[ind].u[1] = fvar[ind].u0[1] + (dt/4.)*( fvar[ind].u[4] - fvar[ind].uy[2] + Gr*fvar[ind].u[5] );     //V2 
		}
	}												
	...
	for(int j=1;j<ny;j++)
	{
		for(int i=1;i<nx;i++) 
		{
			...
			fvar[ind].u[1] = fvar[ind].u0[1] + (dt/3.)*( fvar[ind].u[4] - fvar[ind].uy[2] + Gr*fvar[ind].u[5] );  //V3 
		}
	}
	...
	for(int j=1;j<ny;j++)
	{
		for(int i=1;i<nx;i++) 
		{
			...
			fvar[ind].u[1] = fvar[ind].u0[1] + (dt/2.)*( fvar[ind].u[4] - fvar[ind].uy[2] + Gr*fvar[ind].u[5] );    //V4 
		}
	}
	...
	for(int j=1;j<ny;j++)
	{
		for(int i=1;i<nx;i++)
		{
			...
			fvar[ind].u[1] = fvar[ind].u0[1] + dt*( fvar[ind].u[4] - fvar[ind].uy[2] + Gr*fvar[ind].u[5] );         //V(n+1)
		}
	}	
}
/*************************************************************************************/
