const int DIM=2;
const int NUM_VAR=6;     // U, V, P,H0,H1 corresponding to the indices 0, 1, 2, 3, 4; Here 3 & 4 correspond to advective + viscous fluxes in both the directions 
...
const double l_y = 16.0;    //The height of the 2D channel  
const double l_x = 32.0; //Non dimensional units 
...
const double tot_time = 1500.0; //Some-non-dimenisonal time 
